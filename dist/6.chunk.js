...
var Classroom = (function () {
    ...
    Classroom.prototype.leaveClass = function (room) {
        ...
        this.popupService.popConfirm("Leave Class", "Are you sure to leave the class, " + this.currentUser.userName + "?")
            .catch(function (res) { return console.log("There is an error before the user make the choice"); })
            .then(function (res) {
            ...
            .catch(function (res) { return console.log("Bless you can make it! Keep it!"); });
    };
