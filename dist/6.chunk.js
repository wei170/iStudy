...
var Classroom = (function () {
    ...
    Classroom.prototype.sendRequest = function (reciever, recieverId) {
        var _this = this;
        this.friendService.sendFriendReq(recieverId).subscribe(function (data) {
            _this.alertService.success("Sent Request To " + reciever);
        }, function (error) {
            _this.alertService.error(JSON.parse(error._body).err);
        });
    };
    Classroom.prototype.popInfo = function (userName, userId) {
