...
var router_1 = __webpack_require__("./node_modules/@angular/router/index.js");
var layout_component_1 = __webpack_require__("./src/app/layout/layout.component.ts");
var index_1 = __webpack_require__("./src/app/_guards/index.ts");
...
var index_1 = __webpack_require__("./src/app/_services/index.ts");
var Navbar = (function () {
    function Navbar(el, config, router, userService, popupService) {
    ...
    Navbar.prototype.onDashboardSearch = function () {
        var _this = this;
        // search a user in the entire Purdue user db
        this.userService.searchUser(this.searchName).subscribe(function (data) {
            _this.popupService.popUser(_this.searchName);
        }, function (error) {
            _this.popupService.popError("Error", JSON.parse(error._body).err);
        });
    };
    ...
    // Guocheng
    Navbar.prototype.updateNotificationsNum = function (num) {
...
var Notifications = (function () {
    function Notifications(el, config, friendService, alertService, popupService) {
        this.friendService = friendService;
        this.alertService = alertService;
        this.popupService = popupService;
        this.currentUser = JSON.parse(localStorage.getItem('currentUser'));
        this.friendRequests = [];
        this.numOfNotifications = new core_1.EventEmitter();
        this.$el = jQuery(el.nativeElement);
        this.config = config;
    }
