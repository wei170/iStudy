...
var ClassRegistration = (function () {
    ...
    ClassRegistration.prototype.searchCourse = function () {
        ...
        if (this.step === 0) {
            ...
            this.courseService.getCoursesDetailsFromPurdue(this.model.courseInfo.CourseId).subscribe(function (data) {
                _this.sections = [];
                _this.step = 2;
                for (var _i = 0, data_1 = data; _i < data_1.length; _i++) {
                    var course = data_1[_i];
                    for (var _a = 0, _b = course.Sections; _a < _b.length; _a++) {
                        var sections = _b[_a];
                        if (sections.Type === "Lecture") {
                            for (var _c = 0, _d = sections.Meetings; _c < _d.length; _c++) {
                                var section = _d[_c];
