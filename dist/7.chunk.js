...
var Profile = (function () {
    ...
    Profile.prototype.unFollow = function (victimName, victimId) {
        var _this = this;
        this.friendService.unFriend(this.currentUser.id, victimId).subscribe(function (data) {
            _this.alertService.successWT("Unfollow", "Successfully unfollow" + victimName);
            _this.fetchFriendList();
        }, function (err) {
            console.log(err);
            _this.alertService.error(JSON.parse(err._body).err);
        });
    };
    Profile.prototype.pop = function (userName, userId) {
