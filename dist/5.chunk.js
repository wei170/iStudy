...
var Chat = (function () {
    ...
    Chat.prototype.connet = function () { this.chatService.connect(this.roomName); };
    Chat.prototype.getMessage = function () { this.chatService.getMessage(this.roomName); };
    Chat.prototype.sendMessage = function () { this.chatService.sendMessage(this.message); };
    __decorate([
        core_1.Input(), 
        __metadata('design:type', String)
