...
var UserService = (function () {
    ...
    UserService.prototype.update = function (user) {
        return this.http.put('/users/' + user.id, user).map(function (response) { return response.json(); });
    };
    UserService.prototype.delete = function (id) {
        return this.http.delete('/users/' + id).map(function (response) { return response.json(); });
    };
